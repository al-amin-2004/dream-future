      ...
      <div className="bg-white w-full h-full rounded-2xl space-y-2 md:space-y-5 flex-2/3">
        <div className="flex justify-center h-[45%]">
          <Image
            ...
            height={500}
            alt="Profile Picture"
            className="w-[45%] md:w-[65%] -mt-5 md:-mt-5 rounded-lg h-auto"
          />
        </div>
      ...
      <div className="w-full flex flex-col h-full gap-10">
        <div className="bg-white h-full rounded-xl p-2 md:p-5">
          <div className="flex flex-col-reverse md:flex-row justify-between items-start gap-2">
            ...
            <div
              className={`rounded-full px-3 py-1 text-sm font-medium w-full md:w-auto ${
                hasDeposited ? "bg-green-100 text-green-700" : "bg-red-100 text-red-700"
              }`}
            >
        ...
        <div className="bg-amber-600 h-full rounded-2xl">{/* future features here */}</div>
      </div>
    </div>
  );
};
