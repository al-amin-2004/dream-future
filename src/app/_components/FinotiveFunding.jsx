...
export const FinotiveFunding = () => {
  ...
  return (
    <div
      ref={ref}
      className="md:w-[75%] mx-auto flex flex-col md:flex-row justify-between items-center gap-6 px-4 pt-24 pb-16 md:py-10 font-heading"
    >
