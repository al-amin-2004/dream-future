...
export const FormUid = ({className}) => {
  return (
    <div id="formanimate" className={twMerge("w-full p-4 md:p-5 bg-black/30 dark:bg-white/10 backdrop-blur-sm rounded-lg md:w-[45%] md:mt-36 border border-primary",className)}>
      ...
      <form className="space-y-4 md:space-y-6">
        ...
        <Button className="w-full rounded-sm hover:translate-0">See Profile</Button>
      </form>
    </div>
  )
}